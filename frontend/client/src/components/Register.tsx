...
import { UserPlus, Edit2, Trash2, Camera, Plus, LoaderCircle } from 'lucide-react';
import { Client, Plans } from '../../../types';
import { createClient, getClients, getPlans, updateClient } from '../../../services/api';
...
export const Register = () => {
    ...
    return (
        <div className='w-full h-full'>
            <header className='w-full p-6 flex items-center bg-blue-600 text-white font-3xl text-center font-bold'>
                Trutis
            </header>
